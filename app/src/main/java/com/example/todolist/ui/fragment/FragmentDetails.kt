    ...
    override fun setListeners() {
        mBinding.apply {
            btnComplete.setOnClickListener {
                viewModel.updateFile(parentId, Enums.STATUS.COMPLETED.name)
                    .observe(this@FragmentDetails) {
...
//                findNavController().navigate(R.id.action_fragmentDetails_to_fragmentAddTask, bundle)
    ...
    private fun deleteItem() {
        UtilityFunctions.showAlertDialog(
            ...
            "All tasks liked to file will be deleted.",
    ...
    private fun deleteTask(item: DetailItem) {
        UtilityFunctions.showAlertDialog(
            ...
            "Once deleted the task can not be recovered.",
            object : AlertDialogListener {
                override fun onAccept() {
